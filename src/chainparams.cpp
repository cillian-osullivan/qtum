...
public:
    CMainParams() {
        ...
        chainTxData = ChainTxData{
            ...
            .nTxCount = 0, // * total number of transactions between genesis and that timestamp
            .dTxRate  = 0.0, // * estimated number of transactions per second after that timestamp
        };
